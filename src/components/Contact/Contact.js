            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  <h2>Nos encanta escucharte, contactanos:</h2>
                  <form onSubmit={handleSubmit}>
                    <Row>
                      <Col size={12} sm={6} className="px-1">
                        <input type="text" value={formDetails.fullname} placeholder="Nombre y apellido" onChange={(e) => onFormUpdate('fullname', e.target.value)} />
                      </Col>
                      {/* <Col size={12} sm={6} className="px-1">
